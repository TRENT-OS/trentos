...
BUILD_PLATFORM=${BUILD_PLATFORM:-"sabre"} # -DKernelBenchmarks=track_utilisation
...
#BUILD_PLATFORM=${BUILD_PLATFORM:-"hikey"}
#BUILD_PLATFORM=${BUILD_PLATFORM:-"odroidc2"}
#BUILD_PLATFORM=${BUILD_PLATFORM:-"odroidc4"}
